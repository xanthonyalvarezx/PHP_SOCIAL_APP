<x-layout>
    <a class="ml-4" href="/posts/{{ $post->id }}"><img src="/icons/red_back_arrow.svg" alt="" srcset=""
            height="50" width="50"><sub>back to post</sub></a>
    <div class="container py-md-5 container--narrow">
        <form class="card shadow-lg p-3" action="/update-post/{{ $post->id }}" method="POST">
            @csrf
            @method('PUT')
